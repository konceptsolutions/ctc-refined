...
const subGroups = [
    ...
    { code: "103", name: "Bank Accounts", mainGroupCode: "1" },
    { code: "105", name: "Customer Receivables", mainGroupCode: "1" },
    { code: "104", name: "Old Inventory", mainGroupCode: "1" },
    { code: "301", name: "Purchase Orders Payables", mainGroupCode: "3" },
    { code: "302", name: "Import Purchase expenses Payables", mainGroupCode: "3" },
    { code: "303", name: "Disposed Inventory", mainGroupCode: "3" },
    { code: "304", name: "Loans", mainGroupCode: "3" },
    { code: "305", name: "Branches", mainGroupCode: "3" },
    { code: "306", name: "Direct Purchase EXP Payable", mainGroupCode: "3" },
    { code: "307", name: "Staff Salaries", mainGroupCode: "3" },
    { code: "403", name: "Other Payables", mainGroupCode: "4" },
    ...
    { code: "808", name: "Salary Expense", mainGroupCode: "8" },
...
const accounts = [
    ...
    { code: "105001", name: "General Customer Receivables", subGroupCode: "105", type: "asset" },
    ...
    { code: "305001", name: "KARACHI BRANCH (S)", subGroupCode: "305", type: "liability" },
    { code: "306001", name: "Local Purchase Freight", subGroupCode: "306", type: "liability" },
    { code: "403001", name: "General Other Payables", subGroupCode: "403", type: "liability" },
    ...
    { code: "808001", name: "Staff Salary Expense", subGroupCode: "808", type: "expense" },
